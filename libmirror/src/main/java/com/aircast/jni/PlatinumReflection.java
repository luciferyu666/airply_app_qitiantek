...
public class PlatinumReflection {
    ...
    /*----------------------------------------------------------------*/
    public static final String RENDERER_TOCONTRPOINT_CMD_INTENT_NAME = "com.aircast.platinum.tocontrolpointer.cmd.intent";
    ...
    public static final int MEDIA_RENDER_CTL_MSG_VIDEO_SIZE_CHANGED = (MEDIA_RENDER_CTL_MSG_BASE + 12);
    /*----------------------------------------------------------------*/
    /*
     *
     *
