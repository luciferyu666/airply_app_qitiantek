...
raop_buffer_t *raop_buffer_init(const char *rtpmap, const char *fmtp, const unsigned char *aeskey, const unsigned char *aesiv, int et, int cn);
...
const void *raop_buffer_dequeue(raop_buffer_t *raop_buffer, int *length, int no_resend, unsigned int* timestamp);
